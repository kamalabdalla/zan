        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">ferme aux
algues</h1>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-8">
                    <!-- Blog Detail Start -->
                    <div class="mb-5">
                        <img class="img-fluid w-100 rounded mb-5" src="img/tour/mwani.png" alt="">
                        <h1 class="mb-4">ferme aux
algues</h1>
                        <p>
                            Vous découvrirez aujourd’hui l’agriculture en mer !
Percez les secrets des femmes zanzibarites qui entretiennent de petits champs
d’algues toute l’année, sur ces longs bancs de sable blanc.
Vous visiterez également le centre où elles travaillent en coopérative pour
cultiver et transformer les algues en produits alimentaires ou cosmétiques,
mêlés aux senteurs épicées si typiques de l’île 
</p>
