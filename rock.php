        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Rock Restaurant</h1>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-8">
                    <!-- Blog Detail Start -->
                    <div class="mb-5">
                        <img class="img-fluid w-100 rounded mb-5" src="img/tour/rock.jpg" alt="">
                        <h1 class="mb-4">The Rock Restaurant Zanzibar
</h1>
                        <p>The Rock Restaurant Zanzibar, also known as Rock Caffe for some travelers.
                        It is on rock built restaurant which is located in Michamvi Pingwe, South East Coast of Zanzibar. This Restaurant is among famous restaurant 
                        in Zanzibar Islands. From the Rock Restaurant, you can have your seafoods delicious; Lobsters, squid, Octopus, Crabs, oysters, etc.
 

</p>
                       <p>The best way to go the Rock Restaurant, is to book your transport with us.
                        And then we are here to provide you a transport from your Hotel to the the rock. No hassle, we will help you to book your table.</p>
