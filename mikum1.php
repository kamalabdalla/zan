        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Mikumi National Park</h1>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-8">
                    <!-- Blog Detail Start -->
                    <div class="mb-5">
                        <img class="img-fluid w-100 rounded mb-5" src="img/tour/mikum1.jpeg" alt="">
                        <h1 class="mb-4">2 DAYS 1 NIGHTS IN MIKUMI NATIONAL PARK </h1>
                        <p>
                            DAY 1 :(evening game drive)
                            pick up from your hotel to stone town for a ferry boat to daresalam, the driver will be ready to pick you to Mikumi national park will stop at msolwa restaurant for lunch the continue the drive to Mikumi National Park, will arrive late afternoon and start a half day game drive till late evening after sunset then to the camp for dinner and overnight.
                           <p>
                               📍DAY 2 :(morning game drive)
                               very early in the morning 6am pick up for another half day game drive till 8:30 back to the camp for breakfast then start a tea sfer back to daresalam for a ferry boat to Zanzibar, the driver will be ready to pick you back to your hotel.
                            </p>
