        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Deep Sea Fishing</h1>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-8">
                    <!-- Blog Detail Start -->
                    <div class="mb-5">
                        <img class="img-fluid w-100 rounded mb-5" src="img/tour/mnemba2.jpg" alt="">
                        <h1 class="mb-4"> DEEP SEA FISHING </h1>
                        <p>
                            
                            Our Half Day Zanzibar Fishing Charter is the perfect way to Escape your Hotel and spend a Morning or an Afternoon looking for some Adrenaline filled Fishing Action! Join us onboard for a few hours of Fishing Fun out on the warm tropical waters of Zanzibar!
                           <h6>
                        ...
                        <p>
                            During our Half Day Zanzibar Fishing Charter, we focus on the fishing areas of Leven Bank (which lies 6 miles north of Nungwi), the Zanzibar Channel and the north east coast of Zanzibar Island. Of course if it is quiet inshore, we will head offshore in search of better fishing should time allow during the course of your Fishing Charter.
