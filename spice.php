        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Welcome Spice Farms</h1>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-8">
                    <!-- Blog Detail Start -->
                    <div class="mb-5">
                        <img class="img-fluid w-100 rounded mb-5" src="img/tour/spic1.png" alt="">
                        <h1 class="mb-4">SPICE TOUR </h1>
                        <p>La visite commence au cœur des plantations locales, pour sentir et goûter
diverses variétés d’épices et de fruits tropicaux (ananas, banane verte, jus de
noix de coco, dourian, pomme d’amour, litchis, etc.).
Sur l’île sont aussi cultivées de nombreuses épices aux saveurs exotiques telles
que le clou de girofle, la cardamome, la cannelle, le poivre noir, curcuma, vanille
et la muscade. Vous découvrirez ici de nombreuses saveurs dont certaines qui
vous sont sans doute encore inconnues </p>
