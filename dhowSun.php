        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Dhow Sunset Cruise</h1>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-8">
                    <!-- Blog Detail Start -->
                    <div class="mb-5">
                        <img class="img-fluid w-100 rounded mb-5" src="img/tour/sea2.jpeg" alt="">
                        <h1 class="mb-4">DHOW SUNSET CRUISE</h1>
                        <p>
                            The best way to experience the glorious Zanzibar sunset. On a traditional wooden dhow with the wind in your sail and a glass of wine in your hand as you cruise along watching the setting sun cast gold and amber hues on the North Zanzibar coast.
                        ...
                        <p>
                            ...
                            The sunset cruise leaves at 16:30 from our beach at Kendwa Rocks, and returns around 18:30, just after the sun has set . Crack open the ice box and dig in to the wonderful liquid and edible treats that it holds as the sun dips below the horizon and the boat leisurely sails
                        </p>
                            <!-- 
